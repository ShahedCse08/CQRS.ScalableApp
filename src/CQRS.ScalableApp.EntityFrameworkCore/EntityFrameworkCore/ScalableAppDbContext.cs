...
public class ScalableAppDbContext :
    AbpDbContext<ScalableAppDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(ScalableAppConsts.DbTablePrefix + "YourEntities", ScalableAppConsts.DbSchema);
        ...
        {
            b.ToTable(ScalableAppConsts.DbTablePrefix + "Books",
                ScalableAppConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
